...
def create_db_table():
    ...
    print('Table created: meta_data,site_url,url_font_map.')
...
def insert_metadata(fontMetaDataList):
    ...
    # print('Record inserted: meta_data --------------------------- Table_1.')
...
def insert_site_url(reqUrl,yrlType,metaID):
    ...
    db_connection.commit() # when working with table data.
    # print('Record inserted: site_url --------------------------- Table_2.')
    return db_cursor.lastrowid
...
def insert_url_font_map(sourceUrl,fontUrl):
    ...
    db_connection.commit() # when working with table data.
    # print('Record inserted: url_font_map --------------------------- Table_2.')
